          ...
          <div className={s.container}>
            <div className={s.help_inner}>
              ...
              <div className={s.help_text}>
                ...
                uismod egestas Lorem ipsum dolor sit amet, consectetur
                ...
                mauris tristique. Consectetur id pretium semper Lorem ipsum
                dolor sit amet, consectetur adipiscing elit. Id venenatis
                convallis amet eu et ipsum. Ac, donec viverra tristique elit
                euismod molestie uismod egestas Lorem ipsum dolor sit amet,
                consectetur adipiscing elit. Id venenatis convallis amet eu et
                ipsum. Ac, donec viverra tristique elit euismod molestie uismod
                egestas egestas. Sollicitudin sed adipiscing eu, ipsum purus et
                etiam mauris tristique. Consectetur id pretium semper Lorem
                ipsum dolor sit amet, consectetur adipiscing elit. Id venenatis
                convallis amet eu et ipsum. Ac, donec viverra tristique elit
                euismod molestie uismod egestas
              </div>
            </div>
          </div>
        </div>
