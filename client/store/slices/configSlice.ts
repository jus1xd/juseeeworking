...
export const configSlice = createSlice ( {
    ...
    reducers: {
        changeColorsAndSiteLogo: ( state, action ) => {
            ...
            state.config.colors.underHeaderColor = action.payload.colors.underHeaderColor
            state.config.colors.fontColor = action.payload.colors.fontColor
            state.config.colors.backgroundColor = action.payload.colors.backgroundColor
        ...
        deleteCategory: ( state, action ) => {
            state.config.categories = state.config.categories.filter ( category => category != action.payload )
        }
    },
    extraReducers: {
...
export const {changeColorsAndSiteLogo, changeTof, changeHelp, addCategory, deleteCategory} = configSlice.actions
