...
const Software: React.FC = ({}): JSX.Element => {
  ...
  useEffect(() => {
    setClientWidth(body.current.offsetWidth);
  ...
  const nextHandler = () => {
    ...
    setCurPosition((curPosition -= step));
    sliderContent.current.style.transform = `translateX(${curPosition}px)`;
    console.log(curPosition);
    if (Math.abs(curPosition) >= sliderContent.current!.scrollWidth - step) {
      setCurPosition(step);
    }
  };
  const prevHandler = () => {
  ...
  return (
    <>
      ...
      <div className={s.mob_soft_info}>
        <div className={s.container}>
          <div className={s.mob_info_inner}>
            <div className={s.softcard_content}>
              <div className={s.mob_soft_photo}>
                <Image
                  src="/img/SoftCard/cardAvatar.png"
                  width={95}
                  height={95}
              ...
              <div className={s.mob_soft_content}>
                <div className={s.mob_soft_title}>
                  Adobe Photoshop (The last Version)
                </div>
                <div className={s.btn_wrapper}>
                  <div className={s.main_btn}>Download</div>
            ...
            <div className={s.soft_text}>
              ...
              adipiscing elit. Id venenatis amet eu et ipsum. Ac, donec viverra
              tristique elit euismod molestie uismod egestas egestas.
              Sollicitudin sed adipiscing eu, ipsum purus et etiam mauris
              tristique. Consectetur id pretium semper Consectetur id pretium
      ...
      <div className={s.slider} ref={body}>
        <div className={s.container}>
            ...
            <div className={s.track}>
              <div className={s.slider_content} ref={sliderContent}>
                <div className={s.image_container}>
                  <img src="/img/Software/sliderImg.png" />
                </div>
                <div className={s.image_container}>
                  <img src="/img/Software/sliderImg.png" />
                </div>
