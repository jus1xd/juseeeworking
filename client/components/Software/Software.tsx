                ...
                <div className={s.container}>
                    {<div className={`${s.inner} ${s.comments}`}>
                        ...
                        <div className={s.comments_section}>
                            {product.comments.length != 0 ? product.comments.map ( ( comment, idx ) => (
                                <Comment key={idx} commentText={comment.text} author={comment.username}
                                         setState={setIsEmpty}
                                         id={id}/> ) ) : ''}
                        </div>
                        <div className={s.submit_area}>
                            ...
                            <div className={s.btn_wrapper_c}>
                                <div className={s.main_btn} onClick={onSubmitHandler}>Submit</div>
                            </div>
                        </div>
                    </div>
                    }
