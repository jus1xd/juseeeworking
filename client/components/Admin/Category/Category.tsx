                            ...
                            <div className={s.input_container}>
                                ...
                                <div className={s.btn_wrapper}>
                                    <div className={s.main_btn}
                                         onClick={onAddCategoryHandler}>Добавить</div>
                                </div>
                            </div>
                            {isEdit && <div className={s.msg_container}>Категория успешно добавлена</div>}
                            {isEmpty && <div className={s.msg_container_red}>Заполните поле</div>}
                            <div className={s.input_container}>
                                <div className={s.input_wrapper}>
                                    <AdminInput
                                        placeholder={"Название категории"}
                                ...
                                <div className={s.btn_wrapper}>
                                    <div className={s.remove_btn} onClick={onDeleteCategoryHandler}>Удалить</div>
                                </div>
                            </div>
                            {isDelete && <div className={s.error_container}>Категория успешно удалена</div>}
                        </div>
                    </div>
                </div>
            </div>
