...
const Appearance: React.FC = ({}): JSX.Element => {
  const colorConfig = useAppSelector ( state => state.configSlice.config.colors )
  ...
  const onClickHandler = () => {
    if (Object.values (siteColorsAndLogo.colors).every( item => item.length != 0 ) && siteLogo != '') {
            ...
            <div className={s.inner}>
              ...
              <div className={s.columns_container}>
                <div className={s.column}>
                  ...
                  {isEdit && <div className={s.msg_container}>Цвета и логотип успешно изменены</div>}
                ...
                <div className={s.column}>
                  ...
                  {siteLogo == '' && <div className={s.msg_container_red}>Поле не заполнено</div>}
                </div>
              </div>
            </div>
          </div>
